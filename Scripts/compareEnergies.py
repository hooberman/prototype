...
def main():
    ...
    axes[0].hist(bkg_lg, bins=lg_bins, histtype="step", linewidth=1.2, density=True, label="BKG")
    axes[0].hist(sig_lg, bins=lg_bins, histtype="step", linewidth=1.2, density=True, label="SIG")
    ...
    axes[1].hist(bkg_hg, bins=hg_bins, histtype="step", linewidth=1.2, density=True, label="BKG")
    axes[1].hist(sig_hg, bins=hg_bins, histtype="step", linewidth=1.2, density=True, label="SIG")
